...
void main()
{
	gl_Position = gl_ModelViewProjectionMatrix * vec4(vertex_position.xyz * (light_params[gl_InstanceID].position_radius.a + 0.5) + light_params[gl_InstanceID].position_radius.xyz, 1.0);	
}
