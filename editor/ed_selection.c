...
//	unsigned int value;
//
//	editor_EnablePicking(r_renderer.r_window_width, r_renderer.r_window_height);
//
//	//gpu_BindGpuHeap();
//
...
void editor_DrawBrush(struct brush_t *brush, vec4_t color)
{
...
//                    transform_component = (struct transform_component_t *)entity_GetComponentPointer(entity->components[COMPONENT_TYPE_TRANSFORM]);
//					center.x += transform_component->position.x;
//					center.y += transform_component->position.y;
//					center.z += transform_component->position.z;
//				}
//
//			break;
//
