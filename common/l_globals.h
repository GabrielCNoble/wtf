...
GLOBAL(unsigned int l_light_cache_uniform_buffer);
GLOBAL(unsigned int l_light_cache_element_buffer);
GLOBAL(unsigned int l_light_cache_shadow_element_buffer);
GLOBAL(unsigned int l_light_cache_shadow_maps[LIGHT_CACHE_SIZE]);
GLOBAL(int *l_light_cache_index_buffer_base);
GLOBAL(int *l_light_cache_groups_next);
GLOBAL(int *l_light_cache_frustum_counts);
GLOBAL(int *l_light_cache_index_buffers[LIGHT_CACHE_SIZE]);
GLOBAL(light_cache_slot_t l_light_cache[LIGHT_CACHE_SIZE]);
...
GLOBAL(shadow_map_t *l_shadow_maps);
